...
export const rooms = [
  ...
  },
  {
    ...
    horrorLevel: HorrorLevels.NOT_HORROR,
    horrorTypes: [],
    room_properties: [RoomProperties.COMPETITIVE],
  ...
  },
  {
    ...
    horrorLevel: HorrorLevels.NOT_HORROR,
    horrorTypes: [],
    room_properties: [RoomProperties.PUZZLE_FOCUSED, RoomProperties.COMPETITIVE],
    expectedTier: RoomTier.AVERAGE,
  ...
  },
  {
    ...
    expectedTier: RoomTier.AVERAGE,
    imageUrl: "https://www.escaperoomlover.com/storage/files/keops-space-project-h-kdEX2.jpg",
    location: "Barcelona",
    terpeca2024: null,
    minutesByCar: 120,
    minutesByPublicTransport: 106
